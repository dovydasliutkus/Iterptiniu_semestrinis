...
uint32_t adcValue;
float itampa = 0.0;
char suvis_display[40];
char itampa_display[40];
typedef enum {DATA_READY,DATA_WAIT,DATA_RESET}SData;
SData status = DATA_WAIT;
int measureVoltage = 0;
uint8_t suvis_total = 0;
uint8_t pertaisymai = 0;
